...
export default function Home() {
  ...
  return (
    <div className="flex md:flex-row flex-col-reverse md:min-h-screen bg-background">
      {/*The alignment should be in column in smaller screens */}
      {/* Left Side */}
      {!isMobile && (
      <div className="md:w-1/2  flex flex-col items-center mt-10 ">
        <Image loading="eager" src={CampusMind} alt="Campus Mind" title="Campus Mind"  className="md:h-[300] md:w-[300]  "/>
      ...
      {/* Right Side */}
      <div className="md:w-1/2  flex justify-center item-start p-10">
        ...
        {/* Login Form */}
          <form onSubmit={handleLogin} className=" absolute bg-background shadow-md rounded px-8 pt-6 pb-8 w-full max-w-md backface-hidden">
          ...
          {/* Sign Up Form */}
          <form onSubmit={handleSignUp} className="absolute backface-hidden bg-background shadow-md rounded px-8 pt-6 pb-8 w-full max-w-md rotate-y-180">
            ...
            <div className="mb-4">
              ...
              className="shadow appearance-none border rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline"
              />
              <label className="block text-primary font-bold text-sm mb-2 ">University</label>
              <input type="text" placeholder="University" value={university} onChange={(e) => setUniversity(e.target.value) }
              className="shadow appearance-none border rounded w-full py-2 px-3 text-white leading-tight focus:outline-none focus:shadow-outline"
              />
              <label className="block text-primary font-bold text-sm mb-2 ">Course</label>
